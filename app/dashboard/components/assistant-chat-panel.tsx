...
export function AssistantChatPanel({
   ...
   return (
      <section className={`flex min-h-[600px] flex-col overflow-hidden rounded-[2.5rem] border border-slate-200/60 bg-white/70 shadow-premium backdrop-blur-xl transition-all duration-300 dark:border-slate-800/60 dark:bg-slate-900/50 ${className}`}>
         <header className="flex items-center gap-4 border-b border-slate-100/80 px-8 py-5 dark:border-slate-800/80">
