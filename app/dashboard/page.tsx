...
export default function DashboardPage() {
  ...
  if (loading) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-[#f8fafc] text-slate-900 selection:bg-blue-100 selection:text-blue-900">
        ...
        <div className="relative z-10 flex flex-col items-center gap-6 animate-pulse">
          <div className="grid h-16 w-16 place-items-center rounded-2xl bg-gradient-to-tr from-blue-600 to-indigo-500 text-white shadow-xl shadow-blue-500/30">
