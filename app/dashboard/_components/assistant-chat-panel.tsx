...
import type { ChatMessage, QuickAction } from "./dashboard-types";
  ...
  return (
    <section className="flex min-h-[620px] flex-col overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
      <header className="flex items-center gap-4 border-b border-slate-100 px-6 py-5">
        ...
        <div>
          <h2 className="text-xl font-semibold text-slate-900">AI Study Assistant</h2>
          <p className="text-sm text-slate-500">Always online to help you learn</p>
        </div>
      </header>
