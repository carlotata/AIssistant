    ...
    return (
        <aside className="w-80 border-r border-white/5 bg-slate-900 p-4 flex flex-col h-screen">
            ...
            <nav className="flex-1 space-y-1">
                <button onClick={() => onNavigate("users")} className="flex w-full items-center gap-3 rounded-lg px-4 py-2 text-sm text-slate-400 hover:bg-slate-800 hover:text-white">
                    <UsersIcon className="h-4 w-4" />
                    User Management
                </button>
                <button onClick={() => onNavigate("logs")} className="flex w-full items-center gap-3 rounded-lg px-4 py-2 text-sm text-slate-400 hover:bg-slate-800 hover:text-white">
